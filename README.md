...
This repository contains a derived analysis package built from the public source repository `Gusb3ll/thailand-public-train-data`.

Source repository:

- https://github.com/Gusb3ll/thailand-public-train-data

See `NOTICE.md` for source and license context.
